...
for (i = 0; i < accordThree.length; i++) {
 ...
 let scrollButtonOne = document.querySelector('.section-preheader-content__nav-list__whywe');
 ...
 let scrollButtonTwo = document.querySelector('.section-preheader-content__nav-list__promo');
 ...
 let scrollButtonThree = document.querySelector('.section-preheader-content__nav-list__instructions');
